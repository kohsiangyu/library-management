...
<html xmlns=" http://www.w3.org/1999/xhtml ">
	<head>
		...
		<script src="./js/json-borrow.js" type="text/javascript"></script>
	...
	<body>
						<!-- New Book
						=============================================================== -->
							<form class="form-horizontal" id="newrecordform">
								<fieldset>
									<div id="legend">
									...
									<div class="control-group">
										<!-- Push Data -->
										<div class="controls">
											<label class="checkbox"><input type="checkbox" name="sendnewrecord" value="send" checked> Send Info Mail</label>
